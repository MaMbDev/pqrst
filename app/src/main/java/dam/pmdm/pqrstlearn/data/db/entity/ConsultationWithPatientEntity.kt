...
/**
 * Non-entity projection returned by the JOIN query in [dam.pmdm.pqrstlearn.data.db.dao.ConsultationDao.observeAll].
 *
 ...
 *
 * This projection is mapped to the [dam.pmdm.pqrstlearn.domain.model.ConsultationWithPatient] domain
