...
interface EcgPatternDao {
     ...
     * for a specific pattern referenced by a [dam.pmdm.pqrstlearn.data.db.entity.ComparisonEntity].
     *
     ...
     *
     * Deleting a pattern also cascade-deletes any [dam.pmdm.pqrstlearn.data.db.entity.ComparisonEntity]
