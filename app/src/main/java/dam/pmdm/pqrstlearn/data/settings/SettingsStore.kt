package dam.pmdm.pqrstlearn.data.settings
 ...
 * recomposition.
 *
 * **Why reuse the same [DataStore] instance as [dam.pmdm.pqrstlearn.data.auth.SessionStore]?**
...
class SettingsStore @Inject constructor(
     ...
     * - `"en"` — force English
     *
     * Applied in [dam.pmdm.pqrstlearn.MainActivity] via
