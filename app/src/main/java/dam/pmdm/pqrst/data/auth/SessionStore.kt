 ...
 * without requiring re-login (see [dam.pmdm.pqrst.data.auth.AuthRepositoryImpl]).
 *
 ...
 * with [dam.pmdm.pqrst.data.settings.SettingsStore] (via the same injected [DataStore]
