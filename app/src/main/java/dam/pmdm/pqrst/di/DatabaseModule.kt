 ...
 * [dam.pmdm.pqrst.data.auth.SessionStore] and [dam.pmdm.pqrst.data.settings.SettingsStore].
...
object DatabaseModule {
     ...
     *
     * This single instance is shared between [dam.pmdm.pqrst.data.auth.SessionStore]
     * and [dam.pmdm.pqrst.data.settings.SettingsStore]; keys are namespaced to avoid
