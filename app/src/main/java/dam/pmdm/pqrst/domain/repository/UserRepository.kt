 ...
 *
 * Access to this repository is restricted to users with the [dam.pmdm.pqrst.domain.model.UserRole.ADMIN]
 * role. The presentation layer is responsible for enforcing this gate (e.g. by checking the active
 * [dam.pmdm.pqrst.domain.model.Session.role] before exposing the user management screen).
 *
